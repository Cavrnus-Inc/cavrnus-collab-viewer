...
AActor* SpawnObjectHelpers::SpawnUserAndSetup(UWorld* World, TSubclassOf<AActor> ActorClass, const FCavrnusUser& User)
{
...
void SpawnObjectHelpers::HandleSpawnedUser(AActor* actor, const FCavrnusUser& user)
{
