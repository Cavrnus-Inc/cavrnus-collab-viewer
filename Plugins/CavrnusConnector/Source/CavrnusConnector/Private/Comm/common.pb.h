...
class ResourceTag;
struct ResourceTagDefaultTypeInternal;
extern ResourceTagDefaultTypeInternal _ResourceTag_default_instance_;
}  // namespace Common
PROTOBUF_NAMESPACE_OPEN
...
template<> ::Common::ResourceTag* Arena::CreateMaybeMessage<::Common::ResourceTag>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace Common {
...
class ResourceTag final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Common.ResourceTag) */ {
 public:
  inline ResourceTag() : ResourceTag(nullptr) {}
  ~ResourceTag() override;
  explicit PROTOBUF_CONSTEXPR ResourceTag(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  ResourceTag(const ResourceTag& from);
  ResourceTag(ResourceTag&& from) noexcept
    : ResourceTag() {
    *this = ::std::move(from);
  }

  inline ResourceTag& operator=(const ResourceTag& from) {
    CopyFrom(from);
    return *this;
  }
  inline ResourceTag& operator=(ResourceTag&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const ResourceTag& default_instance() {
    return *internal_default_instance();
  }
  static inline const ResourceTag* internal_default_instance() {
    return reinterpret_cast<const ResourceTag*>(
               &_ResourceTag_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    14;

  friend void swap(ResourceTag& a, ResourceTag& b) {
    a.Swap(&b);
  }
  inline void Swap(ResourceTag* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(ResourceTag* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  ResourceTag* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<ResourceTag>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const ResourceTag& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const ResourceTag& from) {
    ResourceTag::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ResourceTag* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "Common.ResourceTag";
  }
  protected:
  explicit ResourceTag(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:Common.ResourceTag)
 private:
  class _Internal;
...
// string key = 1;
inline void ResourceTag::clear_key() {
  _impl_.key_.ClearToEmpty();
}
inline const std::string& ResourceTag::key() const {
  // @@protoc_insertion_point(field_get:Common.ResourceTag.key)
  return _internal_key();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ResourceTag::set_key(ArgT0&& arg0, ArgT... args) {
 
 _impl_.key_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Common.ResourceTag.key)
}
inline std::string* ResourceTag::mutable_key() {
  std::string* _s = _internal_mutable_key();
  // @@protoc_insertion_point(field_mutable:Common.ResourceTag.key)
  return _s;
}
inline const std::string& ResourceTag::_internal_key() const {
  return _impl_.key_.Get();
}
inline void ResourceTag::_internal_set_key(const std::string& value) {
  
  _impl_.key_.Set(value, GetArenaForAllocation());
}
inline std::string* ResourceTag::_internal_mutable_key() {
  
  return _impl_.key_.Mutable(GetArenaForAllocation());
}
inline std::string* ResourceTag::release_key() {
  // @@protoc_insertion_point(field_release:Common.ResourceTag.key)
  return _impl_.key_.Release();
}
inline void ResourceTag::set_allocated_key(std::string* key) {
  if (key != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:Common.ResourceTag.key)
}

// string value = 2;
inline void ResourceTag::clear_value() {
  _impl_.value_.ClearToEmpty();
}
inline const std::string& ResourceTag::value() const {
  // @@protoc_insertion_point(field_get:Common.ResourceTag.value)
  return _internal_value();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ResourceTag::set_value(ArgT0&& arg0, ArgT... args) {
 
 _impl_.value_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Common.ResourceTag.value)
}
inline std::string* ResourceTag::mutable_value() {
  std::string* _s = _internal_mutable_value();
  // @@protoc_insertion_point(field_mutable:Common.ResourceTag.value)
  return _s;
}
inline const std::string& ResourceTag::_internal_value() const {
  return _impl_.value_.Get();
}
inline void ResourceTag::_internal_set_value(const std::string& value) {
  
  _impl_.value_.Set(value, GetArenaForAllocation());
}
inline std::string* ResourceTag::_internal_mutable_value() {
  
  return _impl_.value_.Mutable(GetArenaForAllocation());
}
inline std::string* ResourceTag::release_value() {
  // @@protoc_insertion_point(field_release:Common.ResourceTag.value)
  return _impl_.value_.Release();
}
inline void ResourceTag::set_allocated_value(std::string* value) {
  if (value != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:Common.ResourceTag.value)
}
